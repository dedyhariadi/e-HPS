...
<div class="container">
    <div class="col">
        <div class="row">
            <h2 class="my-4">Form Tambah Dasar Surat</h2>
        </div>

        <div class="row">


            <?= form_open_multipart('dasarsurat/simpan'); ?>
            <div class="row mb-3">
                <!-- input no Surat -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-floating col-sm-4">
                    <textarea class="form-control <?= (isset($errors['tentang'])) ? 'is-invalid' : ''; ?>" placeholder="Masukkan perihal tentang surat" id="tentang" style="height: 100px" name="tentang"><?= set_value('tentang'); ?></textarea>
